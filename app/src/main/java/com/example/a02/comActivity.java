...
public class comActivity extends AppCompatActivity {
    ...
    private String JsonString, JsonRating;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storeNo = extras.getString("storeNo");
        storeViews = extras.getString("storeViews");
        Rating = extras.getString("storeRating");
        ...
        if (check.equals("on")) {
            ...
            newStore.execute("http://" + IP_ADDRESS + "/newStore.php", title, address, category,region);
            Handler handler1 = new Handler();
            handler1.postDelayed(new Runnable() {
                @Override
                public void run() {
                    newStoreCommenttable newStoreCommenttable = new newStoreCommenttable();
                    newStoreCommenttable.execute("http://" + IP_ADDRESS + "/newStoreComment.php", storeNo);
                }
            }, 200);
        }
    ...
    private class newStore extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(comActivity.this,
        ...
        protected String doInBackground(String... params) {
            ...
            String postParameters = "title=" + searchKeyword1 + "&address=" + searchKeyword2 + "&kinds=" + searchKeyword3
                     + "&region=" + searchKeyword4;
            try {
    ...
    private class newComment extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equals("fail")) {
                Toast.makeText(comActivity.this, "계정당 댓글을 하나만 작성할 수 있습니다.", Toast.LENGTH_SHORT).show();
    ...
    private class newStoreCommenttable extends AsyncTask<String, Void, String> {
